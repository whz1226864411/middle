...
public class Similarity {
		...
		public static double getSimilarity(Image image1,Image image2) throws IOException{
			int[] pixels1 = getGraypixel(image1);
			int[] pixels2 = getGraypixel(image2);
		...
		//获取灰度像素的比较数组（即图像指纹序列）
		 private static int[] getGraypixel(Image image) throws IOException{
		      // 转换至灰度
